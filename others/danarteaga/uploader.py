...
Image Uploader - uploads images to Google Drive
'''
import sys
...
if __name__ == '__main__':         
    try:
        ...
        if option.lower() == 'snap':
            FileUploader(cfg_path).upload_snapshot(vid_path)
        elif option.lower() == 'snapurl':
            FileUploader(cfg_path).get_snapshot_url(vid_path)
        else:
            FileUploader(cfg_path).upload_video(vid_path)
